...
internal fun executeLinuxArm64DesktopEvidenceBundle(
    ...
    try {
        ...
        executeLinuxArm64DesktopEvidenceInputs(
            candidateCommit, test, classifier, DesktopRuntimeExecutables(appServer, supervisor),
            metadata.appServer.sha256, metadata.supervisor.sha256, evidence, report, environment, runner,
        )
...
internal fun executeLinuxArm64DesktopEvidenceInputs(
    ...
    evidence.atomicWriteJson(buildDesktopRuntimeEvidence(DesktopRuntimeEvidenceValues(
        candidateCommit, LINUX_ARM64_TARGET, binarySha256, supervisorSha256, classifier.releaseDigest(),
    )))
}
...
internal fun runDesktopEvidenceProcess(command: List<String>, environment: Map<String, String>): DesktopEvidenceProcessResult {
